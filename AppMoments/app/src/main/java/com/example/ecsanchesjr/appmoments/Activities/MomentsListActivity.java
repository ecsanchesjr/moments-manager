...
public class MomentsListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        momentsList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
        ...
        momentsList.setMultiChoiceModeListener(new AbsListView.MultiChoiceModeListener() {
            ...
            public void onItemCheckedStateChanged(ActionMode mode, int position, long id, boolean checked) {
                ...
                //view.setBackgroundColor((isSelected ? Color.LTGRAY : Color.TRANSPARENT));
            ...
            public void onDestroyActionMode(ActionMode mode) {
                for (int i = 0; i < momentsList.getChildCount(); i++) {
                    momentsList.getChildAt(i).setBackgroundColor(Color.TRANSPARENT);
                }
            }
        });
        populateMomentsList();
    ...
    private void populateMomentsList() {
        momentListAdapter = new MomentListAdapter(this, loadMoments());
